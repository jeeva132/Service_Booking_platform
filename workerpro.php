    ...
    <div class="card mb-3">
        <div class="card-body">
            <?php if ($user) { ?>
                ...
                <?php } else { ?>
                    <form method="POST" action="workerpro.php" id="serviceForm">
                        <div class="profile-details">
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="input-group mb-3">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                <li><a class="dropdown-item" href="workerpro.php?specialization=Electrician">Electrician</a></li>
                                                                <li><a class="dropdown-item" href="workerpro.php?specialization=Plumber">Plumber</a></li>
                                                                <li><a class="dropdown-item" href="workerpro.php?specialization=Gardener">Gardener</a></li>
                                                                <li><a class="dropdown-item" href="workerpro.php?specialization=House%20Cleaner">House Cleaner</a></li>
                                                                <li><a class="dropdown-item" href="workerpro.php?specialization=Handyman">Handyman</a></li>
                                                                <li><a class="dropdown-item" href="workerpro.php?specialization=HVAC%20Technician%20(Heating,%20Ventilation,%20and%20Air%20Conditioning)">HVAC Technician (Heating, Ventilation, and Air Conditioning)</a></li>
                                                                <li><a class="dropdown-item" href="workerpro.php?specialization=Painter">Painter</a></li>
                                                                <li><a class="dropdown-item" href="workerpro.php?specialization=Roofing%20Contractor">Roofing Contractor</a></li>
                                                                <li><a class="dropdown-item" href="workerpro.php?specialization=Pest%20Control%20Services">Pest Control Services</a></li>
                                                                <li><a class="dropdown-item" href="workerpro.php?specialization=Locksmith">Locksmith</a></li>
                                                                <li><a class="dropdown-item" href="workerpro.php?specialization=Appliance%20Repair%20Technician">Appliance Repair Technician</a></li>
                                                                <li><a class="dropdown-item" href="workerpro.php?specialization=Moving%20Company">Moving Company</a></li>
                                                                <li><a class="dropdown-item" href="workerpro.php?specialization=Carpet%20Cleaner">Carpet Cleaner</a></li>
                                                                <li><a class="dropdown-item" href="workerpro.php?specialization=Interior%20Designer">Interior Designer</a></li>
                                                                <li><a class="dropdown-item" href="workerpro.php?specialization=Home%20Security%20System%20Installation">Home Security System Installation</a></li>
                                                                <li><a class="dropdown-item" href="workerpro.php?specialization=Home%20Theater%20Installation">Home Theater Installation</a></li>
                                                                <li><a class="dropdown-item" href="workerpro.php?specialization=Landscaping%20Services">Landscaping Services</a></li>
                                                                <li><a class="dropdown-item" href="workerpro.php?specialization=Auto%20Mechanic">Auto Mechanic</a></li>
                                                                <li><a class="dropdown-item" href="workerpro.php?specialization=Mobile%20Phone%20Repair">Mobile Phone Repair</a></li>
                                                                <li><a class="dropdown-item" href="workerpro.php?specialization=Computer%20Repair%20Technician">Computer Repair Technician</a></li>
                                                                <li><a class="dropdown-item" href="workerpro.php?specialization=Pet%20Grooming">Pet Grooming</a></li>
                                                                <li><a class="dropdown-item" href="workerpro.php?specialization=Personal%20Trainer">Personal Trainer</a></li>
                                                                <li><a class="dropdown-item" href="workerpro.php?specialization=Massage%20Therapist">Massage Therapist</a></li>
                                                                <li><a class="dropdown-item" href="workerpro.php?specialization=Catering%20Services">Catering Services</a></li>
                                                                <li><a class="dropdown-item" href="workerpro.php?specialization=Event%20Planner">Event Planner</a></li>
                                                                <li><a class="dropdown-item" href="workerpro.php?specialization=Graphic%20Designer">Graphic Designer</a></li>
                                                                <li><a class="dropdown-item" href="workerpro.php?specialization=Web%20Developer">Web Developer</a></li>
                                                                <li><a class="dropdown-item" href="workerpro.php?specialization=Tutoring%20Services">Tutoring Services</a></li>
                                                                <li><a class="dropdown-item" href="workerpro.php?specialization=Personal%20Chef">Personal Chef</a></li>
                                                                <li><a class="dropdown-item" href="workerpro.php?specialization=Car%20Wash%20and%20Detailing%20Service">Car Wash and Detailing Service</a></li>
                                                                </ul>
                                        </div>
                ...
                <?php } else { ?>
                    <form method="POST" action="workerpro.php">
                        <div class="profile-details">
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="input-group mb-3">
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="statusDropdown<?php echo $row["booking_id"]; ?>">
                                                <li><a class="dropdown-item" href="update_booking_status.php?booking_id=<?php echo $row["booking_id"]; ?>&status=Accept">Accept</a></li>
                                                <li><a class="dropdown-item" href="update_booking_status.php?booking_id=<?php echo $row["booking_id"]; ?>&status=Cancel">Cancel</a></li>
                                                <li><a class="dropdown-item" href="update_booking_status.php?booking_id=<?php echo $row["booking_id"]; ?>&status=Complete">Complete</a></li>
                                            </ul>
                                        </div>
                                    </td>
                                </tr>
        ...
        <hr>
        <h4 class="mb-4">Write a Query or a Message to Admin</h4>
                <form method="post" action="message.php">
                    <div class="message-form">
                        <div class="form-group">
                            <input type="hidden" name="user_id" value="<?php echo $_SESSION['worker_id']; ?>">
                            <label for="textAreaExample">Your Message</label>
                            <textarea class="form-control" name="message" id="textAreaExample" rows="4" placeholder="Type your message here..."></textarea>
                        </div>
